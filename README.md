...
## Описание проекта
Парсер вакансий **QA-тестировщиков** для с сайта [hh.ru](https://hh.ru).  
...
```
git clone [https://github.com/greek1984/hh_qa.git]
```
**2. Перейдите в каталог проекта:**
```commandline
cd scrapping-portfolio/hh_qa
```
...
HTML-страница → hh_qa/data/page0.html

Excel-файл → hh_qa/data/hh_page0.xlsx
